                ...
                <div class="card-body">
                    ...
                    {{-- <div id="inner-content" class="d-inline-flex p-3"> --}}
                        <div class="col-md-12 p-1 float-left" >
                            <div class="card mb-3">
                                <div class="card-body">
                                    <form onsubmit="return fromSubmit(this);" method="POST" action="{{ route('groupAccount.store') }}">
                                        @csrf
                                        @method('POST')
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <label for="accountHeadType" class="col-md-2 col-form-label text-md-left">{{ __('Account Head Type') }}&nbsp;<span class="mandatory">*</span></label>
